...
import {blogIdInputParamValidation, postValidations
...
blogRouter.post('/:blogId/posts', authMiddleware, blogIdInputParamValidation, postValidations, postControllers.createPostByBlogId)
