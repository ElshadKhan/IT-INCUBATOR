...
import {postRoutValidators} from "../middleware/postMiddleware/postInputControlMiddleware";
...
postRouter.post('/', authMiddleware, postRoutValidators, inputValidation, postControllers.createPost)
